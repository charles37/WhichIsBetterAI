...
hoist f ComparisonRepository {selectComparison, selectAllComparisons, doComparisonSingle, doComparisonAllModels} =
    ComparisonRepository (f . selectComparison) (f selectAllComparisons) (((f .) .) . doComparisonSingle) ((f .) . doComparisonAllModels)
